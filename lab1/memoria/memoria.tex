...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{eliminación de 313 stopwords españolas}: reduce vocabulario 52\% con impacto mixto en modelos clásicos (+0.91 pp LogReg, -0.26 pp Stacking), y perjudica ligeramente a algunos LLMs (KaLM -1.67 pp F1).
    ...
    \item \textbf{Evolución V1 → V2 valida refinamiento iterativo}: La segunda iteración logró mejoras sustanciales en LLMs (F2LLM-4B) y modestas en modelos clásicos (LogReg +0.91 pp F1). Stacking empeoró ligeramente (-0.26 pp F1), demostrando que el preprocesamiento agresivo no siempre beneficia ensambles complejos. Demuestra valor de experimentación sistemática y evaluación crítica de cambios.
