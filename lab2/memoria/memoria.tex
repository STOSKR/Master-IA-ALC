...
\subsection{Preprocesamiento}
    ...
    Se dispone de un dataset con imágenes, su texto extraído, su descripción y datos multimodales tales como EEG, ET y HR. En primer lugar, se realizó un análisis previo para determinar qué variables multimodales eran significativas para su posible uso posterior. Las variables seleccionadas fueron las siguientes:
    ...
    Por otra parte, para modelos de solo texto se utilizó en algún momento como entrada la descripción de la imagen junto con el texto extraído.
