...
\pagestyle{fancy}
\fancyhf{}
\rhead{Laboratorio 2 - EXIST 2026}
...
\begin{table}[h]
	...
	\begin{tabular}{@{}lcccc@{}}
		...
		& embeddings             & \xmark       &     0.78         &    0.77        \\
		\midrule
		\multirow{1}{*}{InternVL 2.5 26B}
		& imagen + descripción + texto    &  \xmark       &     0.77         &    0.76        \\
		\midrule
		...
		& imagen + descripción + texto    &  \cmark       &     0.79         &    0.77        \\
		\midrule
		\multirow{2}{*}{Pixtral 12B}
		& imagen + descripción + texto    &  \xmark       &     0.77         &    0.75        \\
		& imagen + descripción + texto    &  \cmark       &     \textbf{0.80}         &    \textbf{0.78}        \\
		\bottomrule
	\end{tabular}
